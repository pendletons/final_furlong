defmodule FinalFurlong.Accounts.Message do
  @moduledoc """
  ...
  2. Remove the lib/final_furlong/mailer.ex file
  ...
  defp prep_mail(address) do
    new_email()
    |> to(address)
    |> from(System.get_env("ADMIN_EMAIL") || "admin@example.com")
  end
end
